...
const { Other, Prepend, CR, LF, Control, Extend, Regional_Indicator, SpacingMark, L, V, T, LV, LVT, ZWJ, ExtPict} = classes
...
const codePointAt = (str: string, idx: number) => { // different from String#codePointAt with low surrogate
