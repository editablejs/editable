import { RefObject, append, element } from "@editablejs/dom-utils";
import { CreateIcon, IconProps, IconState } from "../interfaces/icon";
...
const wrapperClassName = cx(css`${tw`leading-[0] inline-block text-center align-[-.125rem] text-inherit font-normal`}`,
  css`
  > svg {
...
const updateState = (wrapper: HTMLElement, state: IconState, prevState: IconState) => {
  const svgElment = wrapper.querySelector('svg') as SVGElement
  const { className, width, height, onClick, onMouseDown } = state
  if (!shallow(state.className, prevState.className)) {
    wrapper.className = [wrapperClassName, className].join(' ')
  }
  svgElment.setAttribute('width', `${width ?? '1em'}`)
  svgElment.setAttribute('height', `${height ?? '1em'}`)
  wrapper.onclick = onClick ?? null
  wrapper.onmousedown = onMouseDown ?? null
}

const createIconStore = (wrapper: HTMLElement, state: IconState, ref?: RefObject<StoreApi<IconState>>, onUpdate?: typeof updateState) => {
  const store = createStore(() => state)

  if (ref) ref.current = store

  const update = (state: IconState, prevState: IconState) => {
    if (onUpdate) {
      onUpdate(wrapper, state, prevState)
    } else {
      updateState(wrapper, state, prevState)
    }
  }
  ...
  const subscribe = () => {
    ...
    DOM_DISCONNECTED_TO_UNSUBSCRIBE.set(wrapper, unsubscribe)
  }

  DOM_CONNECTED_TO_SUBSCRIBE.set(wrapper, subscribe)

  subscribe()
}

const createTemplateIcon = (template: string, state: IconState, ref?: RefObject<StoreApi<IconState>>, onUpdate?: typeof updateState) => {

  const wrapper = createWrapper()
  wrapper.innerHTML = template

  createIconStore(wrapper, state, ref, onUpdate)

  return wrapper
}

export const createBoldIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
...
export const createItalicIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    view-box="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createUnderlineIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    view-box="0 0 1024 1024"
     version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createStrikethroughIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
...
export const createCodeIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createSubIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createSupIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createCheckIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createBlockquoteIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createUnorderedListIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createOrderedListIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createTaskListIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
  viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createTableIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createTableSplitIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createTableMergeIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createPlusCircleIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createPlusIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createArrowDownIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createArrowUpIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createArrowLeftIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createArrowRightIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createArrowCaretDownIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createCutIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createCopyIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createPasteIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createPasteTextIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createDragIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createMenuIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export const createRedoIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
export const createUndoIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      xmlns="http://www.w3.org/2000/svg"
      version="1.1"
...
const animateSpinClassName = css`${tw`animate-spin`}`

export const createLoadingIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      width="1em"
      height="1em"
    ...
    </svg>` , props, ref, (wrapper, state, prevState) => {
      state.className = cx(animateSpinClassName, state.className)
      updateState(wrapper, state, prevState)
    })
}

export const createHeadingOneIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createHeadingTwoIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createHeadingThreeIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createHeadingFourIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createHeadingFiveIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createHeadingSixIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createLinkIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
     viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createUnLinkIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createImageIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024"
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
...
export const createZoomInIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
...
export const createZoomOutIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createOneToOneIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createRotateLeftIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createRotateRightIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createDownloadIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createCloseIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createHrIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
  viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createAlignLeftIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createAlignCenterIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createAlignRightIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createAlignJustifyIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createLeadingIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createFontColorIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const createBackgroundColorIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
      <path
...
export const createCodeBlockIcon: CreateIcon = (props, ref) => {
  return createTemplateIcon(`<svg
    viewBox="0 0 1024 1024" width="1em" height="1em" fill="currentColor">
...
export const IconMap = {
  bold: createBoldIcon,
  italic: createItalicIcon,
  underline: createUnderlineIcon,
  strikethrough: createStrikethroughIcon,
  code: createCodeIcon,
  sub: createSubIcon,
  sup: createSupIcon,
  check: createCheckIcon,
  blockquote: createBlockquoteIcon,
  unorderedList: createUnorderedListIcon,
  orderedList: createOrderedListIcon,
  taskList: createTaskListIcon,
  table: createTableIcon,
  tableMerge: createTableMergeIcon,
  tableSplit: createTableSplitIcon,
  plus: createPlusIcon,
  plusCircle: createPlusCircleIcon,
  arrowDown: createArrowDownIcon,
  arrowUp: createArrowUpIcon,
  arrowLeft: createArrowLeftIcon,
  arrowRight: createArrowRightIcon,
  arrowCaretDown: createArrowCaretDownIcon,
  copy: createCopyIcon,
  cut: createCutIcon,
  paste: createPasteIcon,
  pasteText: createPasteTextIcon,
  drag: createDragIcon,
  menu: createMenuIcon,
  redo: createRedoIcon,
  undo: createUndoIcon,
  loading: createLoadingIcon,
  headingOne: createHeadingOneIcon,
  headingTwo: createHeadingTwoIcon,
  headingThree: createHeadingThreeIcon,
  headingFour: createHeadingFourIcon,
  headingFive: createHeadingFiveIcon,
  headingSix: createHeadingSixIcon,
  link: createLinkIcon,
  unLink: createUnLinkIcon,
  image: createImageIcon,
  zoomIn: createZoomInIcon,
  zoomOut: createZoomOutIcon,
  oneToOne: createOneToOneIcon,
  rotateLeft: createRotateLeftIcon,
  rotateRight: createRotateRightIcon,
  download: createDownloadIcon,
  close: createCloseIcon,
  hr: createHrIcon,
  alignLeft: createAlignLeftIcon,
  alignCenter: createAlignCenterIcon,
  alignRight: createAlignRightIcon,
  alignJustify: createAlignJustifyIcon,
  leading: createLeadingIcon,
  fontColor: createFontColorIcon,
  backgroundColor: createBackgroundColorIcon,
  codeBlock: createCodeBlockIcon,
}

export type IconName = keyof typeof IconMap

export const createIcon: CreateIcon<IconName> = (props, ref) => {
  const { name, children } = props
  if (name) {
    const icon = IconMap[name]
    if (icon) return icon(props, ref)
  } else if(children) {
    const wrapper = createWrapper()
    createIconStore(wrapper, props, ref, (wrapper, state, prevState) => {
      if (!shallow(state.children, prevState.children)) {
        wrapper.innerHTML = ''
        appendChildren(wrapper, state.children)
      }
      updateState(wrapper, state, prevState)
    })
    return wrapper
  } else {
    throw new Error('icon name or children is required')
  }
}
