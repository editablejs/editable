...
import { getPrimaryEvent, isTouch } from '../utils/event'
...
export interface Editable extends Editor {
  ...
  renderElement: (props: RenderElementProps) => HTMLElement
  renderLeaf: (props: RenderLeafProps) => HTMLElement
  renderPlaceholder: (props: RenderPlaceholderProps) => DOMNode | void | null
...
export const Editable = {
   ...
   */
  focused(editor: Editor): boolean {
    return Focused.getState(editor)
  },
  ...
  readonly(editor: Editor): boolean {
    return Readonly.getState(editor)
  },
