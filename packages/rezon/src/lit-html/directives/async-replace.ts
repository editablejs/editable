...
import { ChildPart, noChange } from '../html'
import { AsyncDirective, directive, DirectiveParameters } from '../async-directive'
import { Pauser, PseudoWeakRef, forAwaitOf } from './private-async-helpers'
...
export class AsyncReplaceDirective extends AsyncDirective {
  ...
  override update(_part: ChildPart, [value, mapper]: DirectiveParameters<this>) {
