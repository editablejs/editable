...
function makeComponent(render: RenderFunction): Creator {
  ...
  function component<P extends object>(
    ...
    const BaseElement =
      (options || (baseElementOrOptions as Options<P>) || {}).baseElement || HTMLElement
    const {
      observedAttributes = [],
      useShadowDOM = true,
      shadowRootInit = {},
...
export type { Component, Constructor as ComponentConstructor, Creator as ComponentCreator }
