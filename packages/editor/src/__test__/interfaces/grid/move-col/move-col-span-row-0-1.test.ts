...
describe('interfaces/grid', () => {
  ...
  it('move-col-span-row-0-1-0-to-1', () => {
  ...
  it('move-col-span-row-0-1-0-to-2', () => {
    editor.children = children.concat()
    Grid.moveCol(editor, {
      at: [0],
      move: 0,
  ...
  it('move-col-span-row-0-1-1-to-3', () => {
    editor.children = children.concat()
    Grid.moveCol(editor, {
      at: [0],
      move: 1,
  ...
  it('move-col-span-row-0-1-2-to-1', () => {
    editor.children = children.concat()
    Grid.moveCol(editor, {
      at: [0],
      move: 2,
  ...
  it('move-col-span-row-0-1-3-to-2', () => {
    editor.children = children.concat()
    Grid.moveCol(editor, {
      at: [0],
      move: 3,
