...
export const EDITOR_TO_INPUT: WeakMap<Editor, HTMLTextAreaElement> =
  new WeakMap();
export const EDITOR_TO_SHADOW: WeakMap<Editor, ShadowRoot | null> =
  new WeakMap();
...
export const IS_DRAW_SELECTION: WeakMap<Editor, (draw: boolean) => void> =
  new WeakMap();
