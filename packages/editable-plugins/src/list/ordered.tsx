import { Editable, isHotkey, Path } from '@editablejs/editable-editor';
...
export const OrderedListEditor = {
  ...
  isOrdered: (editor: Editable, value: any): value is Ordered => {
    return (
      ListEditor.isList(editor, value, ORDERED_LIST_KEY) &&
      value.type === ORDERED_LIST_KEY
    );
  },
...
const LabelElement = ({
  ...
  return (
    <span ref={ref} className={`${prefixCls}-label`}>
