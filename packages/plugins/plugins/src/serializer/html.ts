...
import { withBackgroundColorHTMLSerializerTransform } from '@editablejs/plugin-background-color/serializer/html'
...
import { withAlignHTMLSerializerTransform } from '@editablejs/plugin-align/serializer/html'
