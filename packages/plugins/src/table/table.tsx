...
const TableComponent: React.FC<TableProps> = ({ editor, element, attributes, children }) => {
  ...
  const renderAllHeader = () => {
    ...
    return (
      <div
        ...
        className={classnames('ea-table-all-header', {
          ['ea-table-all-header-full']: selected.allFull,
        })}
      />
    );
  };
  ...
  return (
    ...
    >
      <div
        className={classnames('ea-table', {
          ['ea-table-selected']: ~~selected.count,
          ['ea-table-hover']: isHover,
        })}
        {...attributes}
