...
const TableRowHeaderDefault: React.FC<TableHeaderProps> = ({ editor, table }) => {
      ...
      headers.push(
        <div
          ...
          className={classNames(
            'ea-table-rows-item',
            { ['ea-table-rows-item-hover']: hover },
            { ['ea-table-rows-item-full']: hover && selected.rowFull },
          )}
  ...
  return <div className='ea-table-rows-header'>{headers}</div>;
};
...
const TableColHeaderDefault: React.FC<TableHeaderProps> = ({ editor, table }) => {
    ...
    for (let i = 0; i < colsWidth.length; i++) {
      ...
      headers.push(
        <div
          ...
          className={classNames(
            'ea-table-cols-item',
            { ['ea-table-cols-item-hover']: hover },
            { ['ea-table-cols-item-full']: hover && selected.colFull },
          )}
  ...
  return <div className='ea-table-cols-header'>{headers}</div>;
};
