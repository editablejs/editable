...
function sendGAEvent(isPositive: boolean) {
  ...
  // ga('send', 'event', 'button', 'feedback', window.location.pathname, isPositive ? '1' : '0')
}
  ...
  return (
    <div tw="bg-wash dark:bg-gray-95 m-4 flex w-80 max-w-xs rounded-lg py-3 px-4 shadow-lg lg:w-auto">
      ...
      {!isSubmitted && (
        <button
          aria-label="Yes"
          tw="bg-secondary-button dark:bg-secondary-button-dark dark:text-primary-dark mr-2 rounded-lg px-3 text-primary"
          onClick={() => {
            setIsSubmitted(true)
            onSubmit()
            sendGAEvent(true)
      ...
      {!isSubmitted && (
        <button
          aria-label="No"
          tw="bg-secondary-button dark:bg-secondary-button-dark dark:text-primary-dark rounded-lg px-3 text-primary"
          onClick={() => {
            setIsSubmitted(true)
            onSubmit()
            sendGAEvent(false)
